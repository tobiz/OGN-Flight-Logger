...
FLOGGER_LATITUDE, FLOGGER_LONGITUDE = '49.064288','11.209254'   # Location of airfield
FLOGGER_QNH = 0                                                 # QNH, ie ASL in metres for airfield at lat/logitude, if set to 0, elevation is automatically looked up
FLOGGER_AIRFIELD_DETAILS = "Thalmaessing Airport"          # Location details for use by geocoder. If blank, "" use LAT, LONG etc
...
FLOGGER_AIRFIELD_NAME = "EDPW"                             # Name of Flarm base station for airfield. NOTE MUST BE PROVIDED
